 ...
 * Use the [SettingIntroduceFragment.newInstance] factory method to
...
class SettingIntroduceFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SettingIntroduceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SettingIntroduceFragment().apply {
