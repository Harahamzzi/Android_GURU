...
class BottomSummaryDialog(context: Context) {
    ...
    private lateinit var dialog_dailyBarChart: HorizontalBarChart // 차트
    ...
    fun showPopup() {
        ...
        dialog_dailyBarChart = dialog.findViewById(R.id.dailyBarChart)!!
        ...
        var (nowDateBigGoalList, nowDateBigGoalTimeList, nowDateBigGoalColorList) = findDailyReportData(todayDate)
    ...
    private fun weeklyReport(moveTime: ZonedDateTime, bigGoalArrayList: ArrayList<MutableMap<String, String>>,
        ...
        if (integer_hour == 0 && integer_min == 0) {
            ...
            dialog_weeklyTimeTextView.text = integer_hour.toString() + "시간 " + integer_min.toString() + "분 " + integer_sec+"초"
        } else {
            dialog_weeklyTimeTextView.text = integer_hour.toString() + "시간 " + integer_min.toString() + "분"
        }
    ...
    private fun findDailyReportData(nowDate: LocalDateTime): Triple<ArrayList<String>, ArrayList<BigInteger>, ArrayList<Int>> {
        ...
        todayDateTextView.text = nowDateSplit[0] + "." + nowDateSplit[1] + "." + nowDateSplit[2]
    ...
    private fun createDailyReport(nowDateBigGoalList: ArrayList<String>, nowDateBigGoalTimeList: ArrayList<BigInteger>,
        ...
        dialog_dailyTimeTextView.text = long_hour.toString() + "시간 " + long_min.toString() + "분 " + long_sec.toString() + "초"

        // 리스트 개수만큼 동적 뷰 생성
        for (i in 0 until nowDateBigGoalList.size) {
            var view2: View = LayoutInflater.from(context).inflate(R.layout.container_daily_home_report, dialog_dailyGoalListLayout, false)
            ...
            var temp2DailyBarChart: HorizontalBarChart = totalBarChartApperance(dialog_dailyBarChart) // 그래프 기본 레이아웃 설정
            totalBarChartDate(temp2DailyBarChart, nowDateBigGoalTimeList, totalMilli, nowDateBigGoalColorList)

            // 레이아웃에 객체 추가
            dialog_dailyGoalListLayout.addView(view2)
        }
    }
