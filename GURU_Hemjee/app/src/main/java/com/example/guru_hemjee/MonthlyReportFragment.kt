...
class MonthlyReportFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        dailyBtn3 = view.findViewById(R.id.dailyBtn3)
        weeklyBtn3 = view.findViewById(R.id.weeklyBtn3)
        monthlyBtn3 = view.findViewById(R.id.monthlyBtn3)
        moveMonthlyButton = view.findViewById(R.id.moveMonthlyButton)
        monthlyTextview = view.findViewById(R.id.monthlyTextview)
        monthlyTimeTextview = view.findViewById(R.id.monthlyTimeTextview)
        prevBtn3 = view.findViewById(R.id.prevBtn3)
        nextBtn3 = view.findViewById(R.id.nextBtn3)
        monthlyBarChart = view.findViewById(R.id.monthlyStackBarChart)
        selectBigGoalBtn2 = view.findViewById(R.id.selectBigGoalBtn2)
        monthlyReportListLayout = view.findViewById(R.id.monthlyReportListLayout)
        noGoalTimeView3 = view.findViewById(R.id.noGoalTimeView3)
