...
import com.example.guru_hemjee.databinding.FragmentBigGoalSetupBinding
...
class BigGoalSetupFragment : Fragment() {
    ...
    // binding 변수
    private lateinit var binding: FragmentBigGoalSetupBinding
        ...
        bigGoal_storeButton.setOnClickListener {
            ...
            if (str_biggoal == "") { // 대표목표 입력을 안했다면
                ...
                when (bigGoal_ColorRadioGroup1.checkedRadioButtonId) {
                    R.id.bigGoal_orangeRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.Orange
                    )
                    R.id.bigGoal_yellowRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.Yellow
                    )
                    R.id.bigGoal_noteYellowRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.NoteYellow
                    )
                    R.id.bigGoal_apricotRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.Apricot
                    )
                    R.id.bigGoal_seedBrownRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.SeedBrown
                    )
                    R.id.bigGoal_darkBrownRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.DarkBrown
                    )
                }

                when (bigGoal_ColorRadioGroup2.checkedRadioButtonId) {
                    R.id.bigGoal_lightGreenRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.LightGreen
                    )
                    R.id.bigGoal_greenRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.Green
                    )
                    R.id.bigGoal_lightBlueRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.LightBlue
                    )
                    R.id.bigGoal_blueRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.Blue
                    )
                    R.id.bigGoal_purpleRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.Purple
                    )
                    R.id.bigGoal_pinkRadioButton -> integer_color = ContextCompat.getColor(requireContext(),
                        R.color.Pink
                    )
                }
